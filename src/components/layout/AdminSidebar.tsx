...
import {
    LayoutDashboard, Car, CalendarCheck, Settings,
    LogOut, PlusCircle, BarChart3, Users
} from 'lucide-react';
        ...
        <aside className="w-64 bg-white border-r min-h-screen flex flex-col sticky top-0">
            <div className="p-6 border-b">
                <Link href="/" className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-black tracking-tight text-gray-900 leading-none">
                        Admin<span className="text-blue-600 block text-xs uppercase tracking-widest font-bold">Panel</span>
                    </span>
                </Link>
            </div>
            ...
            <nav className="flex-grow p-4 space-y-2 mt-4">
                ...
                <div className="pt-8 mb-4">
                    <p className="px-4 text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4">Quick Actions</p>
                    <Link
                        href="/admin/cars/new"
