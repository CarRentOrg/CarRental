...
import {
    Users, Fuel, Gauge, ArrowLeft, Calendar,
    ShieldCheck, Zap, Info, MapPin, Star
} from 'lucide-react';
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <div className="bg-white rounded-3xl border p-8 shadow-sm space-y-8">
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="flex items-center space-x-2 mb-2">
                                        <span className="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full uppercase tracking-wider">{car.type}</span>
                                        <div className="flex items-center text-yellow-500 space-x-1">
                                            <Star className="h-4 w-4 fill-current" />
                                            <span className="text-sm font-bold text-gray-900">4.9 (120 reviews)</span>
                                        </div>
                                    </div>
                                    <h1 className="text-4xl font-extrabold text-gray-900">{car.brand} {car.name}</h1>
                                </div>
                                <div className="text-right">
                                    <p className="text-3xl font-extrabold text-blue-600">${car.price_per_day}</p>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                {[
                                    { icon: Users, label: 'Capacity', value: `${car.seats} Persons` },
                        ...
                        <div className="bg-white rounded-3xl border p-8 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    'Bluetooth Connectivity', 'GPS Navigation System', 'Reverse Camera',
                                    'Keyless Entry', 'Heated Seats', 'Child Seat Support',
                                    'Leather Interior', 'Premium Sound System'
                                ].map((feature, i) => (
