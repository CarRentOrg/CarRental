            ...
            <div className="max-w-2xl w-full">
                <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden">
                    <div className="bg-blue-600 p-12 text-center text-white">
                        ...
                        <h1 className="text-4xl font-extrabold mb-4">{t('confirmation.title')}</h1>
                    ...
                    <div className="p-12 space-y-10">
                        <div className="flex justify-center flex-wrap gap-4">
                            <div className="bg-gray-50 px-6 py-4 rounded-2xl border border-gray-100 text-center">
                                <span className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">{t('confirmation.bookingId')}</span>
                                <span className="text-xl font-black text-blue-600">{bookingNumber}</span>
                            </div>
                            <div className="bg-gray-50 px-6 py-4 rounded-2xl border border-gray-100 text-center">
                                <span className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">{t('confirmation.date')}</span>
                                <span className="text-xl font-black text-gray-900">{new Date().toLocaleDateString()}</span>
                            </div>
                        </div>

                        <div className="space-y-6">
                            <h3 className="text-xl font-bold text-gray-900 border-b pb-4">{t('confirmation.nextSteps')}</h3>
