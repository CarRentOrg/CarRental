          ...
          <div className="lg:sticky lg:top-28 lg:self-start space-y-5">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-900/60 border border-zinc-800/60">
              ...
              <span className="text-xs text-zinc-400 font-medium">
                {FAQS.length} {t("faq.answersReady")}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {FAQS.map((item: FAQItem, i: number) => {
              ...
              return (
                <div
                  key={i}
                  className={`group rounded-xl border transition-all duration-500 ${isOpen
                ...
                >
                  ...
                  >
                    {/* Number accent */}
                    <span
                      className={`text-[11px] font-mono tabular-nums shrink-0 transition-colors duration-500 ${isOpen
                          ? "text-zinc-400"
                    ...
                    {/* Question text */}
                    <span
                      className={`flex-1 text-[15px] font-medium transition-colors duration-500 ${isOpen
                          ? "text-white"
                    ...
                    {/* Chevron */}
                    <ChevronDown
                      className={`h-4 w-4 shrink-0 transition-all duration-500 ${isOpen
